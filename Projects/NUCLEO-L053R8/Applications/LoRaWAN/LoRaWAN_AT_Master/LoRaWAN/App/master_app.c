...
//  BSP_sensor_Read(&Sensor);
  ...
  humidity = 150;    // YB: example double percents of humidity
  ...
  temperature = 234; // YB: example decidgrees, to formalize in an equation
  pressure = 11111;  // YB: example daPascals, to formalize in an equation
  humidity = 750;    // YB: example decipercents of humidity, to formalize in an equation 
